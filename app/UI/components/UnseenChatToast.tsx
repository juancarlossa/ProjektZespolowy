...
const UnseenChatToast: FC<UnseenChatToastProps> = ({
  ...
  return (
    <div
      className={t.visible ?
        'max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5 animate-enter' :
        'max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5 animate-leave'}
    >
      <a
